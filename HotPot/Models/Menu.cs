...
namespace HotPot.Models
{
    public class Menu
    {
        ...
        public Menu(int menuId, string name, string type, float price, string? description, string cuisine, TimeSpan? cookingTime, string? tasteInfo, string? itemImage, int nutritionId, int restaurantId)
        {
            MenuId = menuId;
            Name = name;
            Type = type;
