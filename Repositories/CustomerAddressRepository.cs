...
namespace HotPot.Repositories
{
    public class CustomerAddressRepository : IRepository<int, String, CustomerAddress>
    {
        ...
        public CustomerAddressRepository(RequestTrackerContext context, ILogger<CustomerAddressRepository> logger)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public async Task<CustomerAddress> GetAsync(int key)
        {
            ...
            var address = addresses.FirstOrDefault(a => a.AddressId == key);
            if(address!=null)
                return address;
            throw new Exception();
        }
        ...
        {
            var addresses = _context.CustomerAddresses.ToList();
            return addresses;
        }
